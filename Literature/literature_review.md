...
Temporal Constraints: These include Hard Time Windows, where early arrival forces waiting and late arrival causes immediate infeasibility (Bräysy and Gendreau, 2005), and Soft Time Windows, where violations are permitted but penalized financially within the objective function to evaluate cost-service trade-offs (Figliozzi, 2010).
...
Branch-and-Cut-and-Price (BCP): Currently representing the state-of-the-art boundary for exact solvability in heterogeneous routing, this hybridized approach combines the dynamic generation of both columns (routes) and rows (cutting planes), allowing exact solvers to tackle complex instances up to roughly 100 nodes (Baldacci et al., 2008; Choi et al., 2020).
...
Modified Savings Frameworks: Modern adaptations of constructive algorithms alter the traditional "routing savings" calculations to dynamically incorporate heterogeneous capacity thresholds and fixed vehicle activation costs simultaneously (Coelho et al., 2016).
...
Archetti, C., Speranza, M. G., & Vogt, D. (2014). An evaluation of a matheuristic for the vehicle routing problem with backhauls. European Journal of Operational Research, 235(1), 115–124. https://doi.org/10.1016/j.ejor.2013.10.033

Baldacci, R., Battarra, M., & Vigo, D. (2008). Routing a heterogeneous fleet of vehicles. In P. Toth & D. Vigo (Eds.), The Vehicle Routing Problem (pp. 3–27). Society for Industrial and Applied Mathematics. https://doi.org/10.1137/1.9781611973594.ch1
...
Cáceres-Cruz, J., Arias, P., Guimarans, D., Riera, D., & Juan, A. A. (2014). Rich vehicle routing problems: From a logistic policy to a methodologic classification. Central European Journal of Operations Research, 22(2), 325–347. https://doi.org/10.1007/s10100-013-0288-5

Choi, E., Kim, J., & Lee, S. (2020). A branch-and-cut-and-price algorithm for the heterogeneous fleet vehicle routing problem with time windows. Computers & Operations Research, 115, 104850. https://doi.org/10.1016/j.cor.2019.104850

Coelho, V. N., Grasas, A., Ramalhinho, H., Coelho, I. M., Souze, M. J., & Cruz, R. C. (2016). An iterated local search with a savings heuristic for the heterogeneous fleet vehicle routing problem with time windows. Journal of Heuristics, 22(4), 435–461. https://doi.org/10.1007/s10732-015-9290-7

Feillet, D. (2010). A tutorial on branch-and-price in vehicle routing. 4OR: A Quarterly Journal of Operations Research, 8(4), 407–424. https://doi.org/10.1007/s10288-010-0131-4

Figliozzi, M. A. (2010). An iterative route construction and improvement algorithm for the vehicle routing problem with soft time windows. Transportation Research Part C: Emerging Technologies, 18(2), 242–259. https://doi.org/10.1016/j.trc.2009.08.005

Goel, A. (2009). Vehicle routing and scheduling with European regulations on driving hours and rest periods. Transportation Science, 43(1), 39–54. https://doi.org/10.1287/trsc.1080.0243

Holzapfel, A., Hübner, A., & Kuhn, H. (2016). Delivery operations in grocery retailing: A literature review and conceptual framework. International Journal of Retail & Distribution Management, 44(4), 350–377. https://doi.org/10.1108/IJRDM-05-2015-0068
